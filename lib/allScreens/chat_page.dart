...
class ChatPageState extends State<ChatPage> {
  ...
  void _callPhoneNumber(String callPhoneNumber) async {
    // Uri url = 'tel://$callPhoneNumber' as Uri;
    final uri = Uri.parse('tel://$callPhoneNumber');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: isWhite ? Colors.white : Colors.grey.shade900,
              ...
              messageChat.type == TypeMessage.text
                  ? Container(
                      ...
                      margin: EdgeInsets.only(
                          bottom: isLastMessageRight(index) ? 5 : 3,
                          right: 10),
                    )
                      ...
                      : messageChat.type == TypeMessage.image
                          ? Padding(
                            ...
                            child: Container(
                                ...
                                margin: EdgeInsets.only(
                                    bottom: isLastMessageRight(index) ? 10 : 5,
                                    right: 10),
                              ),
                          )
                          : Container(
